...
%ASYMP_PDC  Compute complex and squared partial directed coherence for any
%           of three metrics -- Euclidean, diagonal and informational --
%           along with asymptotic statistics from vector autoregressive
%           (VAR) coefficients in the frequency domain.
%
% Syntax:
