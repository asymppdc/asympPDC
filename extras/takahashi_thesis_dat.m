...
%TAKAHASHI_THESIS_DAT  Takahashi's thesis example: An invertible VMA process
%                      with an infinite order VAR process representation
%                      was simulated
%
% Syntax:
%   u = TAKAHASHI_THESIS_DAT(nPoints)
%
% Input Argument:
%   nPoints:  number of points to generate
%
% Output Argument:
%   u:          matrix with VMA process data columns
%
% Description:
%   Daniel Y Takahashi - Medidas de Fluxo de Informacao com Aplicacao em
%   Neurociencia (Thesis in Portuguese)
