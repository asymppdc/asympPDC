...
strBarTitle = 'Baccala & Sameshima (2001): Example 4';
[hxlabel hylabel] = xplot(strBarTitle,c,flgPrinting,fs,w_max,chLabels,flgColor);
...
%% Original special DTF estimation
%
% PDC analysis results are saved in *d* structure.
% See asymp_dtf.m or issue 
%
...
e = asymp_dtf_special(u,A,pf,nFreqs,metric,alpha);
...
% h=figure;
% set(h,'NumberTitle','off','MenuBar','none', ...
%     'Name', 'Baccala & Sameshima (2001): Example 4 Special DTF')
% [hxlabel hylabel] = xplot(h,e,...
%     flgPrinting,fs,w_max,chLabels,flgColor);
strBarTitle = 'Baccala & Sameshima (2001): Example 4 asymp\_dtf\_special';
[hxlabel,hylabel] = xplot(strBarTitle,e,flgPrinting,fs,w_max,chLabels, ...
                                       flgColor,flgScale,flgMax,flgSignifColor);
xplot_title(alpha,metric,'dtf',strBarTitle);
