function [ u ] = fbaccala2001b_model2( nPoints, nDiscard )
...
% 
% Example 6-dimensional VAR[4] Scalp EEG model II
...
for t=5:N,
   x1(t) = 1.8982*x1(t-1) - 0.9025*x1(t-2)+ ei(1,t);
