...
measure = 'PDC';
[hxlabel hylabel] = xplot('Bacalla2001b Model 1 feedback2',c,...
...
%       'Name', 'Baccala & Sameshima (2001b) Linear Model I')
   [hxlabel,hylabel] = xplot('Baccala & Sameshima (2001b) Linear Model I', ...
                             d,flgPrinting,fs,w_max,chLabels, ...
...
%       'Name', 'Baccala & Sameshima (2001b) Linear Model I with feedback')
   ...
   [hxlabel,hylabel] = xplot('Baccala & Sameshima (2001b) Linear Model I with feedback',e,flgPrinting,fs,w_max,chLabels, ...
                               kflgColor,flgScale,flgMax,flgSignifColor);
   xplot_title(alpha,metric,'dtf', ['Linear model ' ...
