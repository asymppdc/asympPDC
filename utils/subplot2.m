...
%SUBPLOT2 Create axes in tiled positions. 
...
kspacescale=0.7;  % 0.7 is a good value. Zero does not work, because adjacent
                  % plots overlap.
