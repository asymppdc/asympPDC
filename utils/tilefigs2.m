function tilefigs2(handles,resize,nRows,nCols,leftRightSpacing,topBottomSpacing,...
    border,monitor,monitorLocation,monitorSize)
% TILEFIGS2 Tile figures (spread them out). Tile figs has a number of
% arguments, which may either be specified, or entered as [] to use the
% default
%   TILEFIGS2(handles,resize,nRows,nCols,leftRightSpacing,...
%       topBottomSpacing,border,monitor,monitorLocation,monitorSize)
%   TILEFIGS2 , by itself, resizes and tiles all open figures on to the primary monitor
%   TILEFIGS2(handles) Resizes and tiles the figures specified in handles,
%   with the first handle in the upper left corner
%   TILEFIGS2(...,resize) If resize is set to false, the figures will be
%   moved but not resized. Effort has been made to have minimal overlap,
%   but some may still occur.
%   TILEFIGS2(...,nRows) Specifies a number of rows for the tile grid
%   TILEFIGS2(...,nCols) Specifies a number of column for the tile grid.
...
%   TILEFIGS2(...,leftRightSpacing) leaves a horizontal space between the
%   figures. Spacing is specified in pixels. This may have no effect if
%   resize is set to false.
%   TILEFIGS2(...,topBottomSpacing) Same as above, except for vertical
%   spacing
%   TILEFIGS2(...,border) Leaves a border around the tiling of figures.
...
%   TILEFIGS2(...,monitor , monitorLocation,monitorSize) Specifies a monitor to use, 
